...
<div class="container-fluid" style=" background: #fff;width: 55rem;  margin-top: 5rem;">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800" style="margin: 3rem;margin-left: 18rem">Cập Nhật Tài Khoản </h1>
          ...
          ?>
           ...
           @foreach( $taikhoan as $key=>$sua_NhanVien)

            <form  method="post" action="{{URL::to('/admin-capnhat-TaiKhoanAD/'.$sua_NhanVien->id_AD)}}" class="templatemo-login-form"  enctype="multipart/form-data" style="margin: 3rem;width: 55rem; margin-left: 12rem">
          ...
          {{--      <input type="hidden" name="id_AD"> --}}
              ...
              <div class="row form-group">
                  <div class="col-lg-6 col-md-6 form-group">
                    <label style="color: #4e73df">Tên admin</label>
