          ...
          {{--      <input type="hidden" name="id_AD"> --}}
              ...
              <div class="row form-group">
                  <div class="col-lg-6 col-md-6 form-group">
                    ...
                    <input name="TenNV" type="text" required="required" style="font-size: 1rem; width: 100%" class="form-control form-control-user"  placeholder="Nhập tên nhân viên">
              ...
              <div class="row form-group">
                  <div class="col-lg-6 col-md-6 form-group">
                    ...
                    <input name="NgaySinh" required="required"  type="text" required="required" style="font-size: 1rem; width: 100%" class="form-control form-control-user"
                             placeholder="Nhập link ảnh" id="datepicker" >
              ...
              <div class="row form-group">
                  <div class="col-lg-6 col-md-6 form-group">
                    ...
                    <input name="KinhNghiem" required="required"  type="text" required="required" style="font-size: 1rem; width: 100%" class="form-control form-control-user"
              ...
              <div class="row form-group">
               ...
               {{-- <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">
                     <label  style="color: #4e73df">Loại thiết bị &emsp;&emsp;</label>
