...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800" style="margin: 3rem;margin-left: 14rem; font-weight: 700;
          ...
          @foreach($sua_danhmucTB as $key=>$sua)

            <form  action="{{URL::to('/admin-capnhat-danhmucTB/'.$sua->id_DanhMuc)}}"
              ...
              <div class="row form-group">
                  <div class="col-lg-6 col-md-6 form-group">
                    ...
                    <img src="{{URL::to('public/upload/danhmucsanpham/'.$sua->HinhAnh)}}" style="height: 100px; width: 100px">
              ...
              {{-- <div class="row form-group">
                  <div class="col-lg-6 col-md-6 form-group">
                    ...
                    <input name="HinhAnh" value="{{ $sua->HinhAnh}}" type="text" class="form-control form-control-user"   placeholder="Nhập hình ảnh">
