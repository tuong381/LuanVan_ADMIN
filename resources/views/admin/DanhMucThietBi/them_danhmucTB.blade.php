...
<div class="container-fluid" style=" background: #fff;width: 55rem;  margin-top: 5rem;">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800" style="margin: 3rem;margin-left: 14rem; font-weight: 700;
            font-family: 'Font Awesome 5 Free'; font-size: 35px;">Thêm Danh Mục Thiết Bị </h1>
          ...
          ?>
            ...
            <form  action="{{URL::to('/luu_danhmucTB')}}" method="post" class="templatemo-login-form"  enctype="multipart/form-data" style="margin: 3rem;width: 55rem; margin-left: 12rem">
              {{csrf_field()}}
              ...
              {{-- <div class="row form-group">
                  <div class="col-lg-6 col-md-6 form-group">
                    ...
                    <input name="HinhAnh" required="required"  style="font-size: 1rem; width: 100%" type="file"  >
              ...
              {{-- <div class="row form-group">
                  <div class="col-lg-6 col-md-6 form-group">
                    <label style="color: #4e73df">Hình ảnh &emsp;&emsp;</label>
                    <input name="HinhAnh" required="required" type="text" style="font-size: 1rem;
                        width: 100%" class="form-control form-control-user"   placeholder="Nhập Hinh anh" >
              ...
              <button type = "submit" name="them_danhmucTB" class="btn btn-primary btn-user btn-block"
