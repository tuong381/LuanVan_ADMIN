...
<body>
 ...
 <h3 style="color: #91ad41">THÔNG BÁO ĐẶT HÀNG THÀNH CÔNG</h3>
<p>Chào bạn {{$tenKH}}</p>
<p>Cám ơn bạn đã mua sản phẩm tại cửa hàng MarketOnline</p>
<p>Đơn hàng #{{$maHD}} của bạn đặt vào ngày {{$ngayDH}} đã được cửa hàng xác nhận có hàng </p>
<p>Chúng tôi sẽ thông tin đến bạn <label style="font-weight:600">thời gian giao hàng </label>ngay khi sản phẩm được giao cho đối tác vận chuyển.</p>
<p>Bạn vui lòng kiểm tra mail thường xuyên.</p>
...
<div class="container" style="border: 1px solid #91ad41;width: 40rem;">
  ...
  <table class="table table-striped" style="text-align: center;">
   ...
   <label style=" font-weight: 700; padding-left: 2rem "> Người nhận: </label><label>{{$tenDH}} - {{$sdt}} - {{$diachi}}</label>
